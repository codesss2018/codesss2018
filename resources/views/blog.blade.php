    	...
    	<div class="container">
    		<div class="main row">
    			<div class="col-md-8 blog_left">
    				<h4><a href="">Code your dreams with us @ codeS </a></h4>
    				<a href=""><img src="images/blog_pic1.jpg" alt="" class="blog_img img-responsive"/></a>
    				<div class="blog_list">
    				...
    				<div class="read_more">
    					<a href="" class="fa-btn btn-1 btn-1e">view more</a>
    				</div>
    				<h4><a href="">a long established fact that a reader will be distracted</a></h4>
    				<a href=""><img src="images/blog_pic2.jpg" alt="" class="blog_img img-responsive"/></a>
    				<div class="blog_list">
    					  <ul class="list-unstyled">
    						<li><i class="fa fa-calendar-o"></i><span>June 3, 2013</span></li>
    						<li><a href="#"><i class="fa fa-comment"></i><span>Comments</span></a></li>
