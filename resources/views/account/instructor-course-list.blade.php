                       ...
                       <div class="item col-xs-12 col-sm-6 col-lg-4">
                           <div class="panel panel-default paper-shadow" data-z="0.5">
                               ...
                               <div class="panel-body">
                                   <h4 class="text-headline margin-v-0-10"><a href="">Github Webhooks for Beginners</a></h4>
                               </div>
                               <hr class="margin-none" />
                               <div class="panel-body">
                                   <a class="btn btn-white btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href=""><i class="fa fa-fw fa-pencil"></i> Edit course</a>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="item col-xs-12 col-sm-6 col-lg-4">
                           <div class="panel panel-default paper-shadow" data-z="0.5">
                               <div class="cover overlay cover-image-full hover">
                                   ...
                                   <a href="" class="padding-none overlay overlay-full icon-block bg-grey-200">
